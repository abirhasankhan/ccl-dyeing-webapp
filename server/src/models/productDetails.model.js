...
export const productDetails = pgTable("product_details", {
    productdetailid: varchar("productdetailid", { length: 20 }).primaryKey(),
    shipmentid: varchar("shipmentid", { length: 20 })
        .notNull()
    ...
    total_qty_company: integer("total_qty_company"),
    total_grey_received: integer("total_grey_received"),
